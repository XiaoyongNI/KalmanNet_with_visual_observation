...
from Extended_data import N_E, N_CV, N_T, F,H, H_rotated, F_rotated, T, T_test, m1_0, m2_0, m, n, y_size
...
KNet_Pipeline.setTrainingParams(n_Epochs=10, n_Batch=10, learningRate=1e-3, weightDecay=1e-4)
